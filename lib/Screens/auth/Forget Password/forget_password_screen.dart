...
class ForgetPasswordScreen extends StatefulWidget {
  ...
  const ForgetPasswordScreen({super.key, required this.loginController});
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  const CustomText(
                      text:
                          "Enter your registered mobile number and we'll send you a confirmation code to reset your password",
                      fontSize: 4.5,
                  ...
                  CustomTextFormField(
                    ...
                    maxLength: 10,
                    controller:
                        widget.loginController.forgetPassMobileController,
                  ),
                ],
              ),
              Center(
                child: CustomButton(
                  text: 'Verify',
                  onPressed: () {
                    widget.loginController.verifyForgotMobile();
                    /*   widget.loginController
                        .verifyMobileAndSendCode(forget: true)
                        .then((val) {
                      if (val) {
                        // showBottomSheet();
                        Get.to(() => ConfirmOtpScreen(
                            otp: "1234",
                            contactDetail: widget.loginController
                                .forgetPassMobileController.text,
                            sendVia: "Email"));
                      }
                    });*/
                  },
